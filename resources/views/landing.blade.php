...
<section id="testimonio" class="bg-light py-5">
    <div class="container text-center">
        ...
        <div class="d-flex flex-column align-items-center">
            <img src="{{ asset('img/user1.jpg') }}" class="img-fluid rounded-circle mb-3" alt="Imagen Usuario1">
        ...
        <div class="d-flex flex-column align-items-center mt-4">
            <img src="{{ asset('img/user2.jpg') }}" class="img-fluid rounded-circle mb-3" alt="Imagen Usuario2">
            <blockquote class="blockquote">
